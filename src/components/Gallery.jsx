  ...
  const galleryImages = [
    {
      ...
      alt: 'Temporary floor protection on a busy construction site'
    },
    {
      src: heavyMachinery,
      alt: 'Elo Protection panels supporting heavy machinery traffic'
    },
    {
      src: stairway,
      alt: 'Protected stairway with anti-slip coverage'
    },
    {
      src: poolProtection,
      alt: 'Pool deck shielded during renovation'
    },
    {
      src: rainTest,
      alt: 'Water resistance test on Elo Protection panels'
    },
    {
      src: installationProcess,
      alt: 'Team installing Elo Protection system on site'
    },
    {
      src: modularDetail,
      alt: 'Detail of the modular protection system'
    },
    {
      src: galleryNew1,
      alt: 'Residential project secured with Elo Protection'
    },
    {
      src: galleryNew2,
      alt: 'Commercial floor preserved during construction'
    }
  ]
